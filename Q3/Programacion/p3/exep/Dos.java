...
public class Dos {
    private static int metodo(){ // Metodo de clase privado si argumentos pero con retorno de tipo entero
        ...
        try{ //inicia nuestro manejo de excepciones
            ...
            valor=valor+Integer.parseInt("W"); // esto genera un error de tipo dado que w no coresponde a un entero
        ...
        }catch(NumberFormatException e){ // aqui cachamos el error
            ...
            valor=valor+1; // Tomamos el valor "actual de valor" y le sumamos 1 (valor=44)
        ...
        valor=valor+1; // Volvemos a sumarle 1 a valor (valor =45)
